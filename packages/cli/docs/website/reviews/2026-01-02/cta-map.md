...
| Page | Primary CTA | Destination | Notes |
| --- | --- | --- | --- |
| Home (`/`) | See How It Works | `/how-it-works` | Install command is a static copy block (not a link). |
...
## Gaps / Notes
- Ecosystem and Implementation are intentionally hub-style; consider adding a single “Next step” CTA if you want a more linear journey.
